...
local List = {
	...
	["bsrings"] = {
		...
		["Index"] = "bsrings",
		["Name"] = "Rings Shot",
		["Description"] = "O sofrimento nunca teve um gosto tão bom! 850Cal",
		["Durability"] = 36,
		["Weight"] = 1.25,
		["Max"] = 3,
	},
...
function itemDurability(Item)
    -- Converte o item para string se ele for um número
    if type(Item) == "number" then
        Item = tostring(Item)
    end

    -- Verifica se o Item é uma string válida
    if type(Item) ~= "string" then
        print("Erro: 'Item' não é uma string válida. Valor de Item:", tostring(Item))
        return false
    end
