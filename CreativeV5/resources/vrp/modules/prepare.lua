...
vRP.Prepare("accounts/removePremium", "UPDATE accounts SET premium = 0 WHERE license = @license")
...
--vRP.Prepare("vehicles/Driftunistall", "UPDATE vehicles SET drift = 0 WHERE Plate = @Plate")
vRP.Prepare("vehicles/GetDriftStatus", "SELECT drift FROM vehicles WHERE Plate = @Plate") -- Verificar se drift está ativo
vRP.Prepare("vehicles/Drift", " UPDATE vehicles SET drift = 1 WHERE Plate = @Plate") -- Usar para instalar drift
vRP.Prepare("vehicles/DriftUninstall", " UPDATE vehicles SET drift = 0 WHERE Plate = @Plate") -- Usar para remover drift
-----------------------------------------------------------------------------------------------------------------------------------------
-- BANNEDS
-----------------------------------------------------------------------------------------------------------------------------------------
