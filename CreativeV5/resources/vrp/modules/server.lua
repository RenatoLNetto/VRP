...
AddEventHandler("Connect", function(Passport, Source)
    for Permission in pairs(Groups) do
        if Permission ~= "Police" and Permission ~= "Paramedic" and Permission ~= "Mechanic" and Permission ~= "PoliciaMilitar" and Permission ~= "Rota" and Permission ~= "BAEP" and Permission ~= "PoliciaCivil" and Permission ~= "Exercito"then
...
AddEventHandler("CharacterChosen", function(Passport, source)
    ...
    if Datatable and Identity then
        ...
        print('spa')
        -- Chama a função UserPremium após o carregamento do personagem
